...
export default function Hero() {
  return (
    <main>
      ...
      {/* parte 1: HERO */}
      <section className="w-full min-h-screen flex flex-col items-center justify-center text-center px-8 py-20 relative overflow-hidden" style={{background: '#0A0A0F'}}>
        <div className="absolute inset-0 pointer-events-none" style={{background: 'radial-gradient(ellipse 80% 60% at 50% 0%, #6C63FF14 0%, transparent 70%)'}}></div>
        <div className="absolute inset-0 pointer-events-none" style={{backgroundImage: 'radial-gradient(circle, #ffffff06 1px, transparent 1px)', backgroundSize: '32px 32px'}}></div>
        
        <div className="relative max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold mb-7" style={{background: '#6C63FF22', border: '1px solid #6C63FF33', color: '#8B85FF'}}>
            <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{background: '#6C63FF'}}></span>
          ...
          <p className="text-lg mb-10 mx-auto max-w-lg leading-relaxed" style={{color: '#9090A8', fontFamily: 'DM Sans, sans-serif', fontWeight: 300}}>
            Conecta con los mejores trabajadores independientes de tu zona. Rápido, seguro y transparente.
          </p>

          <div className="flex flex-wrap justify-center gap-3 mb-16">
            <button className="flex items-center gap-2 px-7 py-3 rounded-xl font-semibold text-sm transition-all" style={{background: '#6C63FF', color: '#fff', fontFamily: 'DM Sans, sans-serif'}}>
              Necesito a alguien →
            </button>
            <button className="flex items-center gap-2 px-7 py-3 rounded-xl font-semibold text-sm transition-all" style={{background: 'transparent', border: '1px solid #363648', color: '#9090A8', fontFamily: 'DM Sans, sans-serif'}}>
      ...
      <section className="w-full px-8 py-20" style={{background: '#0A0A0F', borderTop: '1px solid #2A2A38'}}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-bold mb-2" style={{fontFamily: 'Syne, sans-serif', fontSize: '28px', color: '#F0F0F8', letterSpacing: '-0.5px'}}>¿Cómo funciona Nexora?</h2>
      ...
      <section className="w-full px-8 py-20" style={{background: '#0A0A0F', borderTop: '1px solid #2A2A38'}}>
        <div className="max-w-5xl mx-auto">
          <h2 className="font-bold mb-2" style={{fontFamily: 'Syne, sans-serif', fontSize: '28px', color: '#F0F0F8', letterSpacing: '-0.5px'}}>Conectando talento</h2>
          <h2 className="font-bold mb-12" style={{fontFamily: 'Syne, sans-serif', fontSize: '28px', color: '#6C63FF', letterSpacing: '-0.5px'}}>Construyendo confianza</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
      ...
      <section className="w-full px-8 py-20" style={{background: '#0A0A0F', borderTop: '1px solid #2A2A38'}}>
        <div className="max-w-5xl mx-auto rounded-2xl p-10 flex flex-col md:flex-row gap-8 items-center" style={{background: '#6C63FF'}}>
          <img src="/persona-1.jpg" alt="personas"
            className="rounded-2xl object-cover shrink-0" style={{width: '280px', height: '200px'}}
          />
          <div>
            ...
            <button className="px-5 py-2.5 rounded-lg text-sm font-semibold text-white transition-all" style={{background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.2)'}}>
              Únete como experto
            </button>
          </div>
        </div>
      ...
      <section className="w-full px-8 py-20" style={{background: '#0A0A0F', borderTop: '1px solid #2A2A38'}}>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          <img src="/tecnologia-1.jpg" alt="Tecnología" className="w-full md:w-1/2 rounded-2xl object-cover shrink-0" style={{height: '280px'}}/>
          <div>
            <p className="text-5xl mb-4" style={{color: '#6C63FF', lineHeight: 1}}>"</p>
            <p className="font-bold leading-snug mb-6" style={{fontFamily: 'Syne, sans-serif', fontSize: '22px', color: '#F0F0F8'}}>
