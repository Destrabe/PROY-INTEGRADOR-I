...
import { loginUser, loginWithGoogle, loginWithGithub } from "../authService";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-[#0A0A0F] font-body text-[#f0f0f5] relative overflow-hidden selection:bg-[#635bff]/30">
      ...
      <div className="w-full max-w-[480px] animate-[cardIn_0.5s_cubic-bezier(0.22,1,0.36,1)_both] z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-3 font-extrabold text-white text-lg bg-gradient-to-br from-[#6C63FF] to-[#9B59B6] font-display">
            N
          </div>
          <span className="font-extrabold text-xl font-display text-[#6C63FF] tracking-tight">
            Nexora
          </span>
        </div>
          ...
          <div className="mb-5 flex flex-col gap-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex flex-col items-center gap-2 py-4 rounded-xl border cursor-pointer transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] ${
                  tipo === "usuario"
                    ? "bg-[#6C63FF]/15 border-[#6C63FF] text-white shadow-[0_0_16px_rgba(108,99,255,0.2)]"
                    : "bg-[#1A1A28] border-[#2A2A38] text-[#9090A8] hover:text-[#F0F0F8] hover:border-white/15"
                }`}
              >
                <svg
                  width="24"
