    ...
    >
      <div className="w-full max-w-md">
        ...
        >
          ...
          {/* Tipo de cuenta */}
          <div className="mb-5">
            <label className="text-xs font-semibold mb-2 block" style={{ color: "#9090A8" }}>
              Tipo de cuenta
            </label>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: "#606078" }}>
          ...
          <div className="flex items-center justify-between mb-5">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm" style={{ color: "#9090A8" }}>Recordarme</span>
            </label>
            <Link href="/forgot-password" className="text-sm" style={{ color: "#6C63FF" }}>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs" style={{ color: "#606078" }}>O continúa con</span>
            <div className="flex-1 h-px" style={{ background: "#2A2A38" }} />
          </div>
          ...
          <p className="text-sm text-center" style={{ color: "#9090A8" }}>
            ...
            <Link href="/register" style={{ color: "#6C63FF", fontWeight: 600 }}>
              Regístrate aquí
            </Link>
          </p>
        </div>
