      ...
      <div className="w-full min-h-screen bg-[#0A0A0F] text-white font-sans selection:bg-[#6c63ff]/30">
        <main className="max-w-7xl mx-auto px-6 pt-28 pb-20 space-y-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {[
              ...
              <div
                key={label}
                className="bg-[#111118] rounded-4xl p-8 text-center border border-white/5"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="space-y-8">
              <div className="bg-[#111118] rounded-[2.5rem] p-8 border border-white/5">
                <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-8">
                  Información
                </h2>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {activeTab === "Trabajos" ? (
                <div className="space-y-6">
                  {jobs.map((job, i) => (
                    ...
                    >
                      ...
                      <div className="flex gap-6 text-[10px] font-black text-slate-600 uppercase tracking-widest mb-6">
                        <span>📅 {job.date}</span>
                ...
                <div className="bg-[#111118] rounded-[2.5rem] p-20 text-center border border-white/5">
        ...
        {showSettings && (
          <div className="fixed inset-0 bg-black/90 backdrop-blur-xl flex items-center justify-center z-100 p-6">
            <div className="bg-[#111118] w-full max-w-2xl rounded-[3rem] p-12 border border-white/5 relative shadow-2xl max-h-[90vh] overflow-y-auto">
              <button
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col items-center gap-6 pb-8 border-b border-white/3">
                  <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-[#6c63ff]">
                    {user?.photoURL ? (
                      ...
                      <div className="w-full h-full bg-[#6c63ff] flex items-center justify-center font-black text-2xl uppercase">
                        {user?.first_name?.[0]}
                      </div>
                    )}
                  </div>
                  <button
                    ...
                    className="text-[10px] font-black uppercase tracking-widest text-[#6c63ff] hover:text-white transition-colors"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0A0A0F] border border-white/10 rounded-2xl px-6 py-4 text-sm focus:ring-2 focus:ring-[#6c63ff] outline-none transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-2">
                ...
                <div className="pt-8 flex gap-4">
                  <button
                    onClick={() => setShowSettings(false)}
                    className="flex-1 py-5 rounded-2xl bg-white/5 font-black uppercase tracking-widest text-[10px] hover:bg-white/10 transition-all"
                  >
                    Cancelar
                  </button>
                  <button
                    ...
                    disabled={uploading}
                    className="flex-1 py-5 rounded-2xl bg-[#6c63ff] font-black uppercase tracking-widest text-[10px] shadow-lg shadow-[#6c63ff]/20 hover:bg-[#5a52d5] transition-all"
                  >
        ...
        {showUploadModal && (
          <div className="fixed inset-0 bg-black/90 backdrop-blur-xl flex items-center justify-center z-110 p-6">
            <div className="bg-[#111118] w-full max-w-lg rounded-[3rem] p-12 border border-white/5 relative shadow-2xl">
              <button
              ...
              <h2 className="text-2xl font-black text-center mb-10 uppercase tracking-widest">
                Seleccionar Foto
              </h2>
              <label className="block border-4 border-dashed border-white/5 rounded-[2.5rem] p-16 text-center hover:border-[#6c63ff]/50 transition-all cursor-pointer bg-white/1">
                <input
                  type="file"
                  accept="image/*"
                  className="hidden"
                ...
                />
                <div className="bg-[#6c63ff]/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 text-[#6c63ff] text-4xl">
                  +
                </div>
        ...
        {showEditModal && (
          <div className="fixed inset-0 bg-black/90 backdrop-blur-xl flex items-center justify-center z-120 p-6">
            <div className="bg-[#111118] w-full max-w-xl rounded-[3rem] p-12 border border-white/5 shadow-2xl">
              <h2 className="text-2xl font-black text-center mb-10 uppercase tracking-widest">
                Ajustar Imagen
              </h2>
              ...
              <input
                ...
                className="w-full h-2 bg-white/5 rounded-full appearance-none accent-[#6c63ff] mb-12"
              />
              <div className="grid grid-cols-2 gap-6">
                <button
                  ...
                  className="py-5 rounded-2xl bg-white/5 font-black uppercase tracking-widest text-[10px]"
                >
                  Cancelar
                </button>
                <button
                  ...
                  disabled={uploading}
                  className="py-5 rounded-2xl bg-[#6c63ff] font-black uppercase tracking-widest text-[10px] shadow-lg shadow-[#6c63ff]/20"
                >
